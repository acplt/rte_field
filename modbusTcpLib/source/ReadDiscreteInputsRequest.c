...
OV_DLLFNCEXPORT OV_RESULT modbusTcpLib_ReadDiscreteInputsRequest_handleResponse(
			...
			do{
				if(((pIOCHannel->v_address - thisReq->v_requestStartAddr) / 8) <= byteCount){
					if(Ov_CanCastTo(modbusTcpLib_DI, pIOCHannel)){
						Ov_StaticPtrCast(modbusTcpLib_DI, pIOCHannel)->v_PV = modbusTcpLib_Request_readBit(dataToHandle, pIOCHannel->v_address - thisReq->v_requestStartAddr);
						Ov_StaticPtrCast(modbusTcpLib_DI, pIOCHannel)->v_PVPV.value = modbusTcpLib_Request_readBit(dataToHandle, pIOCHannel->v_address - thisReq->v_requestStartAddr);
						Ov_StaticPtrCast(modbusTcpLib_DI, pIOCHannel)->v_PVPV.time = timestamp;
						Ov_StaticPtrCast(modbusTcpLib_DI, pIOCHannel)->v_PVPV.state = OV_ST_GOOD;
					}
				} else {
					pIOCHannel->v_error = TRUE;
...
OV_DLLFNCEXPORT OV_RESULT modbusTcpLib_ReadDiscreteInputsRequest_constructor(
	OV_INSTPTR_ov_object 	pobj
) {
    /*    
    *   local variables
    */
    OV_INSTPTR_modbusTcpLib_ReadDiscreteInputsRequest pinst = Ov_StaticPtrCast(modbusTcpLib_ReadDiscreteInputsRequest, pobj);
    OV_RESULT    result;
    ...
    pinst->v_requestType = 02;

    return OV_ERR_OK;
}


OV_DLLFNCEXPORT OV_RESULT modbusTcpLib_ReadDiscreteInputsRequest_sendRequest(
		OV_INSTPTR_modbusTcpLib_Request thisReq
) {
